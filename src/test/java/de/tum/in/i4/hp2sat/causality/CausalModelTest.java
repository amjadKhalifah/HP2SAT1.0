...
public class CausalModelTest {
    ...
    public void Should_FulfillAllACs_When_STIsCauseBS() throws Exception {
        ...
        assertEquals(causalitySolverResultExpectedEval, billySuzy.isCause(context, phi, cause, SolvingStrategy.BRUTE_FORCE));
        assertEquals(causalitySolverResultExpectedSAT, billySuzy.isCause(context, phi, cause, SolvingStrategy.SAT, SATSolverType.MINISAT));
        assertEquals(causalitySolverResultExpectedSAT, billySuzy.isCause(context, phi, cause, SolvingStrategy.SAT, SATSolverType.GLUCOSE));
    }
