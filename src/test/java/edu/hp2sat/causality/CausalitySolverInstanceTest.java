...
public class CausalitySolverInstanceTest {
    ...
    List<SolvingStrategy> solvingStrategies = Arrays.asList(SolvingStrategy.BRUTE_FORCE, SolvingStrategy.SAT,
            SolvingStrategy.SAT_MINIMAL, SolvingStrategy.SAT_COMBINED);
    List<SATSolverType> satSolverTypes = Arrays.asList(SATSolverType.MINISAT, SATSolverType.GLUCOSE, SATSolverType.MINICARD, SATSolverType.CLEANLING);
    ...
    public void Should_FulfillAllACs_When_ST_IsCauseFor_BS() throws Exception {
        ...
        Map<SolvingStrategy, Set<CausalitySolverResult>> causalitySolverResultsExpected =
                new HashMap<SolvingStrategy, Set<CausalitySolverResult>>() {
                    {
                        put(SolvingStrategy.BRUTE_FORCE, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedEval)));
                        put(SolvingStrategy.SAT, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedSAT)));
                        put(SolvingStrategy.SAT_MINIMAL, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedEval)));
                        put(SolvingStrategy.SAT_COMBINED, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedSAT)));
                    }
                };
                ...
                new HashMap<SolvingStrategy, Set<CausalitySolverResult>>() {
                    {
                        put(SolvingStrategy.BRUTE_FORCE, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedEval)));
                        put(SolvingStrategy.SAT, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedSAT)));
                        put(SolvingStrategy.SAT_MINIMAL, new HashSet<>(Arrays.asList(causalitySolverResultExpectedSATMINIMAL1,
    ...
    public void Should_FulfillAC2AC3Only_When_F_IsCauseFor_NotA_Given_LBExoAndFExoAndNotRBExo() throws Exception {
        ...
        testSolve(railroad, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.SAT, SolvingStrategy.SAT_COMBINED);
    }
    ...
    public void Should_FulfillAllAC1AC3Only_When_FSU1_IsCauseFor_SMK() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(stealMasterKey, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
    ...
    public void Should_FulfillAllACs_When_FSU1AndFNU1AndAU1_IsCauseFor_SMK() throws Exception {
        ...
        testSolve(stealMasterKey, context, phi, cause, causalitySolverResultExpected,
                SolvingStrategy.BRUTE_FORCE, SolvingStrategy.SAT, SolvingStrategy.SAT_COMBINED);
    }
    ...
    public void Test_ForAllMinimalCutSets() throws Exception {
        ...
        for (List<Variable> testSet : testSets) {
            ...
            for (Set<Literal> cause : allCauses) {
                ...
                testSolve(leakage, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
            }
        }
    }
    ...
    public void Should_FulfillAllACs_When_X3_IsCauseFor_X41() throws Exception {
        ...
        testSolve(leakage, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE, SolvingStrategy.SAT, SolvingStrategy.SAT_COMBINED);
    }
    ...
    public void Should_FulfillAllAC1AC3Only_When_L31_IsCauseFor_Root0_DEPTH4() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(binaryTreeDepth4, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
    ...
    public void Should_FulfillAllAC1AC3Only_When_L62_IsCauseFor_Root0_DEPTH5() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(binaryTreeDepth5, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
    ...
    public void Should_FulfillAllAC1AC3Only_When_L126_IsCauseFor_Root0_DEPTH6() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(binaryTreeDepth6, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
    ...
    public void Should_FulfillAllAC1AC3Only_When_L254_IsCauseFor_Root0_DEPTH7() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(binaryTreeDepth7, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
    ...
    public void Should_FulfillAllAC1AC3Only_When_L510_IsCauseFor_Root0_DEPTH8() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(binaryTreeDepth8, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
    ...
    public void Should_FulfillAllAC1AC3Only_When_L1022_IsCauseFor_Root0_DEPTH9() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(binaryTreeDepth9, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
                ...
                new HashMap<SolvingStrategy, Set<CausalitySolverResult>>() {
                    {
                         ...
                         * */
                        put(SolvingStrategy.SAT, new HashSet<>(Arrays.asList(causalitySolverResultExpectedSAT,
                                causalitySolverResultExpectedEval)));
                        put(SolvingStrategy.SAT_MINIMAL, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedEval)));
                        put(SolvingStrategy.SAT_COMBINED, new HashSet<>(Arrays.asList(causalitySolverResultExpectedSAT,
                                causalitySolverResultExpectedEval)));
                    }
                };
    ...
    public void Should_FulfillAllACs_When_A_IsCauseFor_C() throws Exception {
        ...
        Map<SolvingStrategy, Set<CausalitySolverResult>> causalitySolverResultsExpected =
                new HashMap<SolvingStrategy, Set<CausalitySolverResult>>() {
                    {
                        put(SolvingStrategy.BRUTE_FORCE, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedEval)));
                        put(SolvingStrategy.SAT, causalitySolverResultsExpectedSAT);
                        put(SolvingStrategy.SAT_MINIMAL, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedEval)));
                        put(SolvingStrategy.SAT_COMBINED, causalitySolverResultsExpectedSAT);
                    }
                };
        testSolve(dummyModel, context, phi, cause, causalitySolverResultsExpected);
    }
    ...
    public void Should_FulfillAC1AC3Only_When_L4094_IsCauseFor_F() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(dummyModel, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, true, true, cause,
                        new HashSet<>(Arrays.asList(f.literal("E", false),
                                ...
                                f.literal("H", false))));
        testSolve(dummyModel, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE,
                 SolvingStrategy.SAT, SolvingStrategy.SAT_COMBINED);
    }
    ...
    public void Should_FulfillAllACs_When_B1IsCauseForXInDummyModel2() throws Exception {
        ...
        Map<SolvingStrategy, Set<CausalitySolverResult>> causalitySolverResultsExpected =
                new HashMap<SolvingStrategy, Set<CausalitySolverResult>>() {
                    {
                        put(SolvingStrategy.BRUTE_FORCE, new HashSet<>(Collections.singletonList(causalitySolverResultExpectedEval)));
                        put(SolvingStrategy.SAT, new HashSet<>(causalitySolverResultsExpectedSAT));
                        put(SolvingStrategy.SAT_MINIMAL, new HashSet<>(causalitySolverResultsExpectedSATMINIMAL));
                        put(SolvingStrategy.SAT_COMBINED, new HashSet<>(causalitySolverResultsExpectedSAT));
                    }
                };
    ...
    public void Should_FulfillAC1AC3Only_When_InBenchmarkModels() throws Exception {
        ...
        CausalitySolverResult causalitySolverResultExpected =
                new CausalitySolverResult(true, false, true, cause, null);
        testSolve(benchmarkModel, context, phi, cause, causalitySolverResultExpected, SolvingStrategy.BRUTE_FORCE);
    }
    ...
    public void Should_ReturnAllCauses_WhenSuzyBillyThrow() throws Exception {
        ...
        Map<SolvingStrategy, Set<CausalitySolverResult>> allCausesExpected =
                new HashMap<SolvingStrategy, Set<CausalitySolverResult>>() {
                    {
                        put(SolvingStrategy.BRUTE_FORCE, allCausesExpectedEval);
                        put(SolvingStrategy.SAT, allCausesExpectedSAT);
                        put(SolvingStrategy.SAT_MINIMAL, allCausesExpectedEval);
                        put(SolvingStrategy.SAT_COMBINED, allCausesExpectedSAT);
                    }
                };
